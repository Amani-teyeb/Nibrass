              ...
              <div className="card2 card border-0 px-4 py-5">
                ...
                <div className="row px-3">
                  ...
                  <input
                    className="mb-4"
                    type="text"
                    name="firstname" placeholder="Enter your first name" onChange={handleChange}
                  />{" "}
                </div>
                <div className="row px-3">
                  {" "}
                  ...
                  <input
                    className="mb-4"
                    type="text"
                    name="lastname" placeholder="Enter your Last name" onChange={handleChange}
                  />{" "}
                </div>
                <div className="row px-3">
                  {" "}
                  ...
                  <input
                    className="mb-4"
                    type="text"
                    name="email" placeholder="Enter email" onChange={handleChange}
                  />{" "}
                </div>
